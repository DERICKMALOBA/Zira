      ...
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-green-600">Transaction Details</h2>
            <button
              onClick={onClose}
...
const SuccessfulTransactions = ({ onViewDetails }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold text-green-600">Successful Transactions</h2>
...
const SuspenseTransactions = ({ onReconcile, onArchive }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mt-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold text-blue-800">Suspense Transactions</h2>
          ...
          <table className="w-full">
            ...
            <tbody>
              {transactions.map((transaction) => (
                <tr key={transaction.id} className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="px-4 py-3 text-sm text-gray-800">{transaction.payer_name || 'N/A'}</td>
                  <td className="px-4 py-3 text-sm text-gray-800">{transaction.phone_number}</td>
                  <td className="px-4 py-3 text-sm font-semibold text-gray-800">
                    KSh {parseFloat(transaction.amount).toLocaleString()}
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-800">{transaction.transaction_id}</td>
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-green-600 mb-2">M-Pesa Transactions</h1>
          <p className="text-gray-600">Manage and monitor all M-Pesa transactions</p>
        </div>
