...
import ViewCustomer from "./ViewCustomerca";
import CustomerVerificationForm from "./CustomerVerificationca";


const PendingAmendmentsca = () => {
...
export default PendingAmendmentsca;