...
const Sidebarca = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      children: [
        { name: 'Chart of Accounts', href: '/accounting/chart-of-accounts/ca', icon: BookOpen },
        { name: 'Journals', href: '/accounting/journals/ca', icon: Book },
        { name: 'Transactions', href: '/accounting/transactions/ca', icon: CreditCard },
        { name: 'Bank Reconciliations', href: '/accounting/bank-reconciliations/ca', icon: Landmark },
      ],
    },
    {
      name: 'Credit Settings',
      href: '/credit-settings/ca',
      icon: Settings,
      color: 'text-purple-400',
      bgColor: 'bg-purple-400/10',
      children: [
        { name: 'Document Settings', href: '/credit-settings/document-settings/ca', icon: FileCheck },
        { name: 'KPI Categories', href: '/credit-settings/kpi-categories/ca', icon: Target },
      ],
    },
    {
      name: 'Registry',
  ...
  children: [
    { name: 'Loans', href: '/loaning/all/ca', icon: FileText },
    { name: 'Loan Pending Branch Manager', href: '/loaning/pending-branch-manager/ca', icon: FileText },
    { name: 'Loan Pending Regional Manager', href: '/loaning/pending-regional-manager/ca', icon: FileText },
    { name: 'Loan Pending Disbursement', href: '/loaning/pending-disbursement/ca', icon: FileText },
    { name: 'Disbursement Loans', href: '/loaning/disbursement-loans/ca', icon: FileText },
    { name: 'Rejected Loans', href: '/loaning/rejected-loans/ca', icon: FileText },
  ],
}
,
    {
      ...
      children: [
        { name: 'Call Center Reports', href: '/reports/call-center-reports/ca', icon: PieChart },
        { name: 'HQ Reports', href: '/reports/hq-reports/ca', icon: TrendingUp },
      ],
    },
  ];
