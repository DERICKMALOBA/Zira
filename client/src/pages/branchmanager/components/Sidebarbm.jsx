...
const Sidebarbm = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  children: [
    { name: 'Loans', href: '/loaning/all/bm', icon: FileText },
    { name: 'Loan Pending Branch Manager', href: '/loaning/pending-branch-manager/bm', icon: FileText },
    { name: 'Loan Pending Regional Manager', href: '/loaning/pending-regional-manager/bm', icon: FileText },
    { name: 'Loan Pending Disbursement', href: '/loaning/pending-disbursement/bm', icon: FileText },
    { name: 'Disbursement Loans', href: '/loaning/disbursement-loans/bm', icon: FileText },
    { name: 'Rejected Loans', href: '/loaning/rejected-loans/bm', icon: FileText },
  ],
}
,
    {
      ...
      children: [
        { name: 'Call Center Reports', href: '/reports/call-center-reports/bm', icon: PieChart },
        { name: 'HQ Reports', href: '/reports/hq-reports/bm', icon: TrendingUp },
      ],
    },
  ];
