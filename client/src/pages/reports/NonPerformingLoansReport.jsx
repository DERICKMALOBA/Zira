  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-sm font-bold text-gray-900">Non-Performing Loans Report</h2>
          {/* <p className="text-gray-600 text-sm mt-1">Track and manage defaulted and overdue loans</p> */}
        </div>
