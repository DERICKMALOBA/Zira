...
const Sidebarrm = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      children: [
        { name: 'Customers', href: '/registry/customers/rm', icon: Users },
        { name: 'Pending Amendments', href: '/registry/pending-amendments/rm', icon: FolderOpen },
        { name: 'Approvals Pending', href: '/registry/approvals-pending/rm', icon: UserCheck },
        { name: 'Callbacks Pending', href: '/registry/callbacks-pending/rm', icon: PhoneCall },
        { name: 'Customer Transfer', href: '/registry/customer-transfer/rm', icon: UserCog },
        { name: 'Customer Categories', href: '/registry/customer-categories/rm', icon: UserPlus },
        { name: 'Customer Edits', href: '/registry/customer-edits/rm', icon: ClipboardList },
      ],
    },
   {
  name: 'Loaning',
  ...
  children: [
    { name: 'Loans', href: '/loaning/all/rm', icon: FileText },
    { name: 'Loan Pending Branch Manager', href: '/loaning/pending-branch-manager/rm', icon: FileText },
    { name: 'Loan Pending Regional Manager', href: '/loaning/pending-regional-manager/rm', icon: FileText },
    { name: 'Loan Pending Disbursement', href: '/loaning/pending-disbursement/rm', icon: FileText },
    { name: 'Disbursement Loans', href: '/loaning/disbursement-loans/rm', icon: FileText },
    { name: 'Rejected Loans', href: '/loaning/rejected-loans/rm', icon: FileText },
  ],
}
,
    {
      ...
      children: [
        { name: 'Call Center Reports', href: '/reports/call-center-reports/rm', icon: PieChart },
        { name: 'HQ Reports', href: '/reports/hq-reports/rm', icon: TrendingUp },
      ],
    },
  ];
